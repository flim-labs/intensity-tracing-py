...
class LinkWidget(QWidget):
    def __init__(self, icon_filename=None, text=None, parent=None, icon_dimensions=25, icon_hover_dimensions=28, link='https://flim-labs.github.io/intensity-tracing-py/products/intensity-tracing/v1.2/#gui-usage'):
