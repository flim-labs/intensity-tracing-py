...
Depending on whether you have chosen to download the script files (Python and/or Matlab) for data analysis on the [Intensity Tracing GUI](../intensity-tracing/v1.6/index.md) or not, follow one of the these guides to visualize the saved data:
